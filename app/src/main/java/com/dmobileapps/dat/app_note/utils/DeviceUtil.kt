...
import com.dmobileapps.dat.app_note.model.FolderObj
...
object DeviceUtil {
     var arrImage: ArrayList<ImageObj> ? = null
...
//        val uri = MediaStore.Images.Media.EXTERNAL_CONTENT_URI
    ...
    fun getImageFromFolder(context: Context, idFolder: Long): ArrayList<ImageObj>? {
        val selection = " media_type = 3 AND " + MediaStore.Images.Media.BUCKET_ID + "=?"
        val arrImage = ArrayList<ImageObj>()
        val projection = arrayOf(
            MediaStore.Images.Media._ID,
            MediaStore.Images.Media.TITLE,
